...
export const SlidersIcon = ({ color }: { color?: string }) => {
  const style1 = {
    fill: "none",
    stroke: color || fallback,
    strokeLinecap: "round" as Property.StrokeLinecap,
    strokeLinejoin: "round" as Property.StrokeLinejoin,
    strokeWidth: "1.8px",
    fillRule: "evenodd" as Property.FillRule
  };
  const style2 = {
    fill: color || fallback,
    stroke: color || fallback,
...
export const InputsIcon = ({ color }: { color?: string }) => {
  const style1 = {
    fill: "none",
    stroke: color || fallback,
    strokeLinecap: "round" as Property.StrokeLinecap,
...
export const PaletteIcon = ({ color }: { color?: string }) => {
  const style1 = { fill: color || fallback };
  const style2 = {
    fill: color || fallback,
    stroke: color || fallback,
    strokeMiterlimit: 10,
